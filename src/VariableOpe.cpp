...
{
    stream << " VariableOpe: " << "Type=" << typeVariable << " Valeur=" << valeur << " " << " Ope=" << ope ;
}

std::ostream& operator<<(std::ostream& stream, const VariableOpe& variableOpe)
{
    stream << " VariableOpe: " << "Type=" << variableOpe.typeVariable << " Valeur=" << variableOpe.valeur << " Ope=" << variableOpe.ope ;
    return stream;
}
